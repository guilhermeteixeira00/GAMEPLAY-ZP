...
public plugin_init()
{
	register_plugin("[ZP] Block Bomb ANTIDOTE", "1.0", "8K300FPS | Teixeira");
	cvar_min_players = register_cvar("bombantidote_min_players", "10");
}

public zp_extra_item_selected_pre(id, itemid) 
{
	new EXTRA_BOMBANT
	if(itemid != EXTRA_BOMBANT) return PLUGIN_CONTINUE;
